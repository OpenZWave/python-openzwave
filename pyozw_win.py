...
if __name__ == '__main__':
    ...
    proc = Popen(get_vsproject_upgrade_command( options, debug=True ), cwd='{0}'.format(options['vsproject']))
    proc.wait()
    ...
    proc = Popen(get_vsproject_build_command( options, debug=True  ), cwd='{0}'.format(options['vsproject']))
    proc.wait()
