# -*- coding: utf-8 -*-
#
# py-openzwave documentation build configuration file, created by
...
project = u'py-openzwave'
copyright = u'2012, bibi21000'
...
htmlhelp_basename = 'py-openzwavedoc'
...
latex_documents = [
  ('index', 'py-openzwave.tex', u'py-openzwave Documentation',
   u'bibi21000', 'manual'),
]
...
man_pages = [
    ('index', 'py-openzwave', u'py-openzwave Documentation',
     [u'bibi21000'], 1)
]
...
texinfo_documents = [
  ('index', 'py-openzwave', u'py-openzwave Documentation',
   u'bibi21000', 'py-openzwave', 'One line description of project.',
   'Miscellaneous'),
]
